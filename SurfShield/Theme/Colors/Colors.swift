...
struct Colors {
    ...
    var backgroundSecondary: Color { ThemeColors.backgroundSecondary.color }
    ...
    var calmAccent: Color { ThemeColors.calmAccent.color }
    var calmAccentSecondary: Color { ThemeColors.calmAccentSecondary.color }
}
